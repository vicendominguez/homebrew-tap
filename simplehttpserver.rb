class Simplehttpserver < Formula
  ...
  if Hardware::CPU.arm?
    url "https://github.com/tu-usuario/simplehttpserver-repo/releases/download/v#{version}/simplehttpserver_#{version}_macOS_arm64.zip"
    sha256 "1905f196dcedbfd69fd1ab726eb21893193aaba6e6a1a3cc7ac574383308c55a"
  else
    url "https://github.com/tu-usuario/simplehttpserver-repo/releases/download/v#{version}/simplehttpserver_#{version}_macOS_amd64.zip"
